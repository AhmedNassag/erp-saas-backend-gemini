...
class UpdateRequest extends FormRequest
{
    ...
    {
        $roles = [
            'name'     => 'required|string|unique:tenant.branches,name,'.$this->branch->id.',id,deleted_at,NULL',
            'code'     => 'required|unique:tenant.branches,code,'.$this->branch->id.',id,deleted_at,NULL',
            'mobile'   => 'required|unique:tenant.branches,mobile,'.$this->branch->id.',id,deleted_at,NULL',
