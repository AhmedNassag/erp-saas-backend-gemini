...
namespace Modules\Core\App\Http\Requests\Branch;
...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        {
            $roles ['name.'.$lang] = 'required|unique:branches,name->'.$lang.','.$this->branch->id.',id,deleted_at,NULL';
        }

        $roles = array_merge($roles, [
            'code'    => 'required|unique:branches,code,'.$this->branch->id.',id,deleted_at,NULL',
