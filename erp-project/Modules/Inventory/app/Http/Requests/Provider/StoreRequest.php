...
class StoreRequest extends FormRequest
{
    ...
    {
        $roles = [
            'name'     => 'required|string|unique:tenant.providers,name,NULL,id,deleted_at,NULL',
            'code'     => 'required|unique:tenant.providers,code,NULL,id,deleted_at,NULL',
            'phone'    => 'required|unique:tenant.providers,phone,NULL,id,deleted_at,NULL',
