...
class StoreRequest extends FormRequest
{
    ...
    {
        $roles = [
            'name'     => 'required|string|unique:tenant.clients,name,NULL,id,deleted_at,NULL',
            'code'     => 'required|unique:tenant.clients,code,NULL,id,deleted_at,NULL',
            'phone'    => 'required|unique:tenant.clients,phone,NULL,id,deleted_at,NULL',
