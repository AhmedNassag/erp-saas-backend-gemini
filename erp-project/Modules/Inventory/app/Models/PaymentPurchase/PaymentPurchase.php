...
namespace Modules\Inventory\Models\PaymentPurchase;
...
class PaymentPurchase extends TenantBaseModel
{
    ...
    public static function getNumberOrder()
    {
        ...
        if ($last && !empty($last->Ref)) {
            ...
            $code       = 'PP_' . str_pad($newNumber, 4, '0', STR_PAD_LEFT);
        } else {
            $code = 'PP_0001';
        }
    ...
    public function scopeFilter($query, PaymentPurchaseFilter $filter)
    {
